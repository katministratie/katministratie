...
namespace Superkatten.Katministratie.Infrastructure.Builders
{
    public class SuperkatDtoBuilder
    {
        ...
        private string _superkatColor { get; set; } = "Red";
        ...
        public SuperkatDtoBuilder WithKLeur(string superkatColor) { _superkatColor = superkatColor; return this; }
